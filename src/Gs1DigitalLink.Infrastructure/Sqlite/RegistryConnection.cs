...
internal sealed class RegistryConnection : SqliteConnection
{
    ...
    internal static void Initialize()
    {
        ...
        connection.Execute("CREATE TABLE IF NOT EXISTS [StoredLinks](Prefix TEXT, RedirectUrl TEXT, Title TEXT, Language TEXT, LinkType TEXT, ApplicableFrom INT, ApplicableTo INT NULL);");
    }
}
